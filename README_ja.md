...
[中国語の詳細ガイド](README_zh.md)

## アクセス数と表示順

対象月は 2026-07、更新日は 2026-09-08。訪問数は推定値で、利用者数や品質評価ではありません。13 製品は SeekTool の二次資料に基づきます。HeyDream と See3D は指定により 3・4 番目に表示し、未確認のアクセス数は N/A とします。Spline は異なる集計元、Hunyuan3D は比較可能な数値がないため順位を付けません。
...
文章・画像からモデル、テクスチャ、リグを作成。ゲーム小物や印刷用の試作に。
...
画像・文章生成とメッシュ・キャラクター機能。キャラクターや低ポリゴン素材の試作に。
...
単一・複数視点の画像、AI 参考画像、プレビューに対応。商品や設計の試作向け。確認時は Tripo 3D H3.1。

[公式サイト](https://heydream.im/image-to-3d/)

### 4. See3D

[![See3D](assets/screenshots/see3d.jpg)](https://see3d.art/)

画像・文章生成とブラウザビューアー。家具、玩具、小物の検討に。表示モデルは Tripo H3.1。無料枠だけでは既定の生成に足りない場合があります。

[公式サイト](https://see3d.art/)

### 5. Hyper3D / Rodin

[![Hyper3D / Rodin](assets/screenshots/hyper3d.jpg)](https://hyper3d.ai/)

参考画像に基づく生成、部分編集、空間制御。装備や製品形状の検討に。

[公式サイト](https://hyper3d.ai/)

### 6. 3D AI Studio

[![3D AI Studio](assets/screenshots/3daistudio.jpg)](https://www.3daistudio.com/)

複数エンジンと素材処理をまとめた作業環境。同じ参考画像で結果を比較。

[公式サイト](https://www.3daistudio.com/)

### 7. Neural4D

[![Neural4D](assets/screenshots/neural4d.jpg)](https://www.neural4d.com/)

生成、テクスチャ、キャラクター機能。教材や印刷用の基礎メッシュに。

[公式サイト](https://www.neural4d.com/)

### 8. Sloyd

[![Sloyd](assets/screenshots/sloyd.jpg)](https://www.sloyd.ai/)

AI 生成と調整可能なテンプレート。家具や小物の統一されたバリエーションに。

[公式サイト](https://www.sloyd.ai/)

### 9. Marble / World Labs

[![Marble / World Labs](assets/screenshots/marble.jpg)](https://www.worldlabs.ai/)

探索可能な世界を生成。部屋の配置やステージの雰囲気を検討。
...
素材とゲーム制作を統合。シーン、キャラクター、遊び方の試作に。

[公式サイト](https://www.seeles.ai/)

### 11. Zoo Design Studio

[![Zoo Design Studio](assets/screenshots/zoo.jpg)](https://zoo.dev/)

編集可能な形状を扱う対話型 CAD。金具、ケース、寸法の検討に。
...
文章・画像から素早くモデル化。小物、置物、AR の試作に。

[公式サイト](https://fast3d.io/)

### 13. Alpha3D

[![Alpha3D](assets/screenshots/alpha3d.jpg)](https://www.alpha3d.io/)

生成から素材処理までの工程。メッシュ、UV、出力の統一に。

[公式サイト](https://www.alpha3d.io/)

### 14. Kaedim

[![Kaedim](assets/screenshots/kaedim.jpg)](https://www.kaedim3d.com/)

チーム向け素材制作。要件管理やゲーム素材の一括レビューに。

[公式サイト](https://www.kaedim3d.com/)

### 15. Masterpiece X / WorldEngen

[![Masterpiece X / WorldEngen](assets/screenshots/masterpiece.jpg)](https://www.masterpiecex.com/)

シーン構成と共同作業。環境の組み立てや制作計画に。

[公式サイト](https://www.masterpiecex.com/)

### 16. Spline

[![Spline](assets/screenshots/spline.jpg)](https://spline.design/ai-generate)

インタラクティブな Web シーンと埋め込み。モバイル性能と読み込みを確認。

[公式サイト](https://spline.design/ai-generate)

### 17. Tencent Hunyuan3D

[![Tencent Hunyuan3D](assets/screenshots/hunyuan3d.jpg)](https://3d.hunyuan.tencent.com/)

公開モデルと推論手順。研究、ローカル実行、カスタマイズに。

[公式サイト](https://3d.hunyuan.tencent.com/)

## 利用手順

ゲーム、商品展示、アニメーション、3D 印刷などの用途を決めます。明瞭な参考画像や形状・材質の説明を用意し、生成後に全方向を確認。形状とテクスチャを修正し、書き出して使用先のソフトで検証します。

## 無料枠と納品条件

無料クレジット、プレビュー、試用期間は条件が異なります。モデル、出力形式、商用利用条件を確認してください。ビューアーの読込形式と生成結果の出力形式は別です。ゲームではトポロジーと UV、印刷では閉じた形状、肉厚、寸法を確認。画像は公開ページと公式デモであり、生成品質の比較実験ではありません。

## 出典と更新

[data/traffic.json](data/traffic.json) · [data/screenshots.json](data/screenshots.json)

[中国語の詳細ガイド](README_zh.md#sources)
