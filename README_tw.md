...
> 本專案來自 [Hey Dream AI](https://heydream.im/) 團隊。
...
收錄 17 款工具，提供截圖、連結與實際用途。本頁為繁體中文精簡版，完整指南見簡體中文版。

[完整簡體中文指南](README_zh.md)

## 流量與展示順序

流量月份：2026-07；更新日期：2026-09-08。訪問量為估算，不是獨立訪客或品質評分。13 款產品採用 SeekTool 轉引的流量數據；HeyDream、See3D 按指定展示順序放在第三、第四位，未核實流量記為 N/A。Spline 的來源口徑不同，混元缺少可比較數據，均不參與排名。
...
快速圖文生成；製作簡單道具、擺件和 AR 草模。

[官方網站](https://fast3d.io/)

### 13. Alpha3D

[![Alpha3D](assets/screenshots/alpha3d.jpg)](https://www.alpha3d.io/)

生成與資產處理流程；統一網格、UV 和匯出。

[官方網站](https://www.alpha3d.io/)
...
[官方網站](https://www.masterpiecex.com/)

### 16. Spline

[![Spline](assets/screenshots/spline.jpg)](https://spline.design/ai-generate)

互動網頁場景與嵌入；需檢查行動裝置效能及載入。

[官方網站](https://spline.design/ai-generate)

### 17. Tencent Hunyuan3D

[![Tencent Hunyuan3D](assets/screenshots/hunyuan3d.jpg)](https://3d.hunyuan.tencent.com/)

開放模型與推論流程；用於研究、本機部署和客製化。

[官方網站](https://3d.hunyuan.tencent.com/)

## 操作流程

先確定遊戲、商品展示、動畫或列印用途，再準備清晰參考圖或物體、形狀與材質描述。生成草模後檢查所有視角，修整幾何與貼圖，最後匯出並在目標軟體驗證。

## 免費範圍與交付

免費積分、預覽與試用各有範圍，須核對模型、下載格式與商用權益。查看器可讀格式不等於生成器可匯出格式。遊戲需檢查拓撲與 UV；列印需檢查水密性、壁厚與尺寸。截圖為公開頁面及官方示例，並非統一生成實測。

## 來源與維護

[data/traffic.json](data/traffic.json) · [data/screenshots.json](data/screenshots.json)

[完整簡體中文指南](README_zh.md#sources)
